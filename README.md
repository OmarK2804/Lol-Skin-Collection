...
First, after adding new necessary imports in 'views.py' inside the main folder we create a function called register. The function will create a registration form automatically. If a registration data is submitted, a user account will be created. Then, we create a new html file inside the template folder inside the main folder called 'register.hmtl'. 
